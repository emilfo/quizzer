        ...
        <section className="card stack">
          <div className="row-between">
            ...
            <div className="stack" style={{ gap: '0.35rem', alignItems: 'flex-end' }}>
              ...
              <span className="muted">answers received</span>
            </div>
          </div>
          ...
          <div className="option-grid">
            {question.options.map((option) => (
              <div
                key={option.id}
                className={`option-card ${getOptionToneClass(option.position)} ${session.round_state === 'round_results' && option.isCorrect ? 'is-correct' : ''}`}
              >
      ...
      <section className="card stack">
        ...
        {session.state === 'finished' ? (
          ...
          <div className="status-list">
            {participants.map((participant) => (
              <div key={participant.id} className="status-row">
                <div>
